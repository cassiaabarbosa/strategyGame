...
class HUD: SKShapeNode {
    ...
    init(rect: CGRect) {
        ...
        endTurnBtn = EndTurnButton(rect: CGRect(x: 300 * Double(wCorrectionMultiplier), y: 40 * Double(hCorrectionMultiplier), width: 60*buttonScale * Double(wCorrectionMultiplier), height: 60*buttonScale * Double(hCorrectionMultiplier)), text: "End")
        attackBtn = AttackButton(rect: CGRect(x: 15 * Double(wCorrectionMultiplier), y: 40 * Double(hCorrectionMultiplier), width: 107*buttonScale*0.75 * Double(wCorrectionMultiplier), height: 39*buttonScale*0.75 * Double(hCorrectionMultiplier)), text: "Attack")
        spAttackBtn = SpecialAttackButton(rect: CGRect(x: 155 * Double(wCorrectionMultiplier), y: 40 * Double(hCorrectionMultiplier), width: 107*buttonScale*0.75 * Double(wCorrectionMultiplier), height: 39*buttonScale*0.75 * Double(hCorrectionMultiplier)), text: "Special")
        settingsBtn = GearButton(rect: CGRect(x: 10 * Double(wCorrectionMultiplier), y: 800 * Double(hCorrectionMultiplier), width: 30*buttonScale * Double(wCorrectionMultiplier), height: 30*buttonScale * Double(hCorrectionMultiplier)))
